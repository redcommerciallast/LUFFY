...
- [ ] **luffy/verl/verl/mix_src/mix_vllm_rollout.py:44** - support pp in vllm
- [ ] **luffy/verl/verl/mix_src/mix_vllm_rollout.py:45** - passing tokenizer is not necessary? no encoding/decoding is happending here
- [ ] **luffy/verl/verl/mix_src/mix_vllm_rollout.py:46** - simplify init logics
...
- [ ] **luffy/verl/verl/workers/rollout/vllm_rollout/vllm_rollout.py:44** - support pp in vllm
- [ ] **luffy/verl/verl/workers/rollout/vllm_rollout/vllm_rollout.py:45** - passing tokenizer is not necessary? no encoding/decoding is happending here
- [ ] **luffy/verl/verl/workers/rollout/vllm_rollout/vllm_rollout.py:46** - simplify init logics
